...
$fp = fopen("chanceheatmaps/$random_filename.csv", 'w');
...
shell_exec("python generate_chanceheatmap.py $random_filename > log/".$date."_debug_rel.log 2>&1");

$im = imagecreatefrompng("chanceheatmaps/".$random_filename.".png");
$im2 = $im;
//$im2 = imagecrop($im, ['x' => 55, 'y' => 100, 'width' => 500, 'height' => 580]);
if ($im2 !== FALSE) {
    imagepng($im2, "chanceheatmaps/".$random_filename.".png");
    imagedestroy($im2);

    $filename = "chanceheatmaps/".$random_filename.".png";
...
$json_image->url = "http://hockeylogic-test.sh10w1.esports.cz/heatmap_python/chanceheatmaps/$random_filename.png";
